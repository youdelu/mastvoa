(function(factory) {
        ...
        _load_node: function(obj, callback) {
            ...
            if (!s) {
                if (obj.id === $.jstree.root) {
                    return this._append_html_data(obj, this._data.core.original_container_html.clone(true),
                    function(status) {
            ...
            if (!this.is_loaded(obj)) {
                ...
                if (d.length) {
                    ...
                    if (!animation) {
                        ...
                        d.children(".jstree-children").css("display", "none").end().removeClass("jstree-closed").addClass("jstree-open").attr("aria-expanded", true).children(".jstree-children").stop(true, true).slideDown(animation,
                        function() {
                            this.style.display = "";
        ...
        close_node: function(obj, animation) {
            ...
            if (d.length) {
                if (!animation) {
                    ...
                    d.children(".jstree-children").attr("style", "display:block !important").end().removeClass("jstree-open").addClass("jstree-closed").attr("aria-expanded", false).children(".jstree-children").stop(true, true).slideUp(animation,
                    function() {
                        this.style.display = "";
                ...
                if (state.core) {
                    ...
                    if (state.core.open) {
                        if (!$.isArray(state.core.open) || !state.core.open.length) {
                            ...
                            this._load_nodes(state.core.open,
                            function(nodes) {
    ...
    $.jstree.plugins.contextmenu = function(options, parent) {
        ...
        $.vakata.context = {
            ...
            show: function(reference, position, data) {
                ...
                switch (cond) {
                case(!position && !reference) : return false;
                case( !! position && !!reference) : vakata_context.reference = reference;
                ...
                case (!position && !!reference) : vakata_context.reference = reference;
                    ...
                    break;
                case ( !! position && !reference) : vakata_context.position_x = position.x;
                    vakata_context.position_y = position.y;
                    break
                }
        ...
        $(function() {
            ...
            vakata_context.element.on("mouseenter", "li",
            function(e) {
                e.stopImmediatePropagation();
            ...
            $(document).on("mousedown.vakata.jstree",
            function(e) {
    ...
    $(function() {
        ...
        $(document).on("dnd_start.vakata.jstree",
        function(e, data) {
            lastmv = false;
            lastev = false;
    ...
    $.jstree.plugins.search = function(options, parent) {
        ...
        this.search = function(str, skip_async, show_only_matches, inside, append, show_only_matches_children) {
            ...
            if (!skip_async && a !== false) {
                if ($.isFunction(a)) {
                    return a.call(this, str, $.proxy(function(d) {
                        ...
                        this._load_nodes(!$.isArray(d) ? [] : $.vakata.array_unique(d),
                        function() {
            ...
            if (r.length) {
                ...
                this._search_open(p);
                if (!append) {
                    this._data.search.dom = $(this.element[0].querySelectorAll("#" + $.map(r,
                    function(v) {
                        return "0123456789".indexOf(v[0]) !== -1 ? "\\3" + v[0] + " " + v.substr(1).replace($.jstree.idregex, "\\$&") : v.replace($.jstree.idregex, "\\$&")
                    }).join(", #")));
                    this._data.search.res = r
                } else {
                    this._data.search.dom = this._data.search.dom.add($(this.element[0].querySelectorAll("#" + $.map(r,
                    function(v) {
                        return "0123456789".indexOf(v[0]) !== -1 ? "\\3" + v[0] + " " + v.substr(1).replace($.jstree.idregex, "\\$&") : v.replace($.jstree.idregex, "\\$&")
                    }).join(", #"))));
        ...
        this.clear_search = function() {
            ...
            if (this._data.search.res.length) {
                this._data.search.dom = $(this.element[0].querySelectorAll("#" + $.map(this._data.search.res,
                function(v) {
                    return "0123456789".indexOf(v[0]) !== -1 ? "\\3" + v[0] + " " + v.substr(1).replace($.jstree.idregex, "\\$&") : v.replace($.jstree.idregex, "\\$&")
                }).join(", #")));
