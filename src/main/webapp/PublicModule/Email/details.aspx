    ...
    <script>
        ...
        $(function () {
            if ($("#msg_flag").val() == "1") {
                ...
                var mailid = $("#msg_mailid").val();
                var id = $("#msg_id").val();
                $(".tool_deldetal").hide();
                showDetails("1", id, mailid, title);
            }
        })
    </script>
</head>
<body>
    <form name="frm_email" method="post" action="./details.aspx" id="frm_email">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUJNDgxOTAwNTM4ZBgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WBAUHcG9wU3NsMQUHcG9wU3NsMAUIc210cFNzbDEFCHNtdHBTc2wwNvA1xj8hbYv2sEe1xcv2wSsxILNN4FrURBbhx0T3KA0=" />

<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="97264961" />
    <input id="msg_flag" type="hidden" value="0" />
    <input id="msg_mailid" type="hidden" value="" />
    <input id="msg_id" type="hidden" value="" />
    <input id="msg_title" type="hidden" value="" />
