				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							%>
							<td><a href="uworkform.do?workformId=<%=row.get(0)%>"><span
									class="glyphicon glyphicon-pencil"></span></a> &nbsp; <a
								data-workformid="<%=row.get(0)%>" href="#"><span
			...
			<div class="text-center">
				<ul class="pagination">
					...
					<%
						if (pageNumber > 1) {
					%>
					<li><a href="lworkform.do?pageNumber=<%=pageNumber - 1%>">&laquo;</a></li>
					<%
						} else {
					%>
					...
					<li <%=(i == pageNumber) ? " class=\"active\"" : ""%>><a
						href="lworkform.do?pageNumber=<%=i%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a href="lworkform.do?pageNumber=<%=pageNumber + 1%>">&raquo;</a></li>
					<%
						} else {
					%>
...
<script>
	$(".glyphicon-remove").parent().on("click", function() {
		var workformId = $(this).data("workformid");
		var wokrform = $(this).parent().parent();
		$.post("lworkform.do", {
