...
<%@ page import="java.util.ArrayList,backend.javabean.Department" %>   
...
<div class="container">
  ...
  <div class="row">
   <div class="col-md-6">
	<form action="cdepartment.do" method="post" class="form-horizontal" role="form">
