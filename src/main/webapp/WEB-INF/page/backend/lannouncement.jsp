				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>  
							<a href="uannouncement?announcementId=<%=row.get(0)%>"><span
									class="glyphicon glyphicon-pencil"></span></a> &nbsp; 
							<a data-announcementid="<%=row.get(0)%>" href="#"><span
			...
			<div class="text-center">
				<ul class="pagination">
					...
					<%
						if (pageNumber > 1) {
					%>
					<li><a href="lannouncement?pageNumber=<%=pageNumber - 1%>">&laquo;</a></li>
					<%
						} else {
					%>
					...
					<li <%=(i == pageNumber) ? " class=\"active\"" : ""%>><a
						href="lannouncement?pageNumber=<%=i%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a href="lannouncement?pageNumber=<%=pageNumber + 1%>">&raquo;</a></li>
					<%
						} else {
					%>
...
<script>
	$(".glyphicon-remove").parent().on("click", function() {
		...
		var announcement = $(this).parent().parent();
		$.post("lannouncement.do", {
