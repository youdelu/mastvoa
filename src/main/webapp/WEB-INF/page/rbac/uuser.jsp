...
<div class="container">
	...
	<form action="uuser.do" method="post" class="form-horizontal" role="form">
...
<script>
	...
	$("#defaultDep").on("click", function() {
		 $.post( "sdefaultdepartment.do", { depid : depid,
			 							 userid : userid
		 }, function( data ) {
	            if(data=="ok") {
	            	alert("部门修改成功");
