				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr<%=row.get(4).toString().equals("2")?" class=\"danger\"":"" %>>
							...
							<td><%=row.get(4).toString().equals("2")?"拒绝":"完成" %></td>
							<td><a href="detaildepartmentflow.do?flowid=<%=row.get(0).toString() %>"><span class="glyphicon glyphicon-pencil">.....</span></a></td>
						</tr>
			...
			<div class="text-center">
				<ul class="pagination">
					...
					<%
						if (pageNumber > 1) {
					%>
					<li><a href="rdepartmentflow.do?pageNumber=<%=pageNumber - 1%>">&laquo;</a></li>
					<%
						} else {
					%>
					...
					%>
								...
								<a href="rdepartmentflow.do?pageNumber=<%=i%>"><%=i%></a></li>
					<%
							}
					...
					%>
					<li><a href="rdepartmentflow.do?pageNumber=<%=pageNumber + 1%>">&raquo;</a></li>
					<%
						} else {
					%>
