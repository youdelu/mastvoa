				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>  
							<a href="nannouncement.do?announcementId=<%=row.get(0)%>"><span class="glyphicon glyphicon-pencil">.....</span></a>
						</tr>
			...
			<div class="text-center">
				<ul class="pagination">
					...
					<%
						if (pageNumber > 1) {
					%>
					<li><a href="rannouncement.do?pageNumber=<%=pageNumber - 1%>">&laquo;</a></li>
					<%
						} else {
					%>
					...
					<li <%=(i == pageNumber) ? " class=\"active\"" : ""%>><a
						href="rannouncement.do?pageNumber=<%=i%>"><%=i%></a></li>
					<%
						}
					...
					%>
					<li><a href="rannouncement.do?pageNumber=<%=pageNumber + 1%>">&raquo;</a></li>
					<%
						} else {
					%>
