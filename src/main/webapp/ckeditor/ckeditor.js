...
(function() {
    ...
    CKEDITOR.event.prototype = function() {
        ...
        b.prototype = {
            getListenerIndex: function(a) {
                for (var d = 0,
                e = this.listeners; d < e.length; d++) if (e[d].fn == a) return d;
                return - 1
            }
        };
        return {
    ...
    CKEDITOR.dom = {}; (function() {
        ...
        CKEDITOR.tools = {
            ...
            extend: function(a) {
                ...
                e, b;
                if (typeof(e = arguments[d - 1]) == "boolean") d--;
                else if (typeof(e = arguments[d - 2]) == "boolean") {
                    b = arguments[d - 1];
                    d = d - 2
                }
                for (var c = 1; c < d; c++) {
            ...
            indexOf: function(a, d) {
                if (typeof d == "function") for (var e = 0,
                b = a.length; e < b; e++) {
                    if (d(a[e])) return e
                } else {
            ...
            normalizeCssText: function(a, d) {
                var e = [],
                b,
                c = CKEDITOR.tools.parseCssText(a, true, d);
            ...
            checkIfAnyArrayItemMatches: function(a, d) {
                for (var e = 0,
                b = a.length; e < b; ++e) if (a[e].match(d)) return true;
                return false
            },
    ...
    CKEDITOR.dom.domObject.prototype = function() {
        ...
        a.setCustomData = function(a, f) {
            var d = this.getUniqueId(); (c[d] || (c[d] = {}))[a] = f;
            return this
        };
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getPrevious: function(a) {
            var c = this.$,
            b;
            do b = (c = c.previousSibling) && c.nodeType != 10 && new CKEDITOR.dom.node(c);
            while (b && a && !a(b));
            return b
        },
        getNext: function(a) {
            var c = this.$,
            b;
            do b = (c = c.nextSibling) && new CKEDITOR.dom.node(c);
            while (b && a && !a(b));
            return b
        },
    ...
    CKEDITOR.dom.element.clearMarkers = function(a, c, b) {
        ...
        function b(a) {
            for (var e = 0,
            b = 0,
            c = f[a].length; b < c; b++) e = e + (parseInt(this.getComputedStyle(f[a][b]) || 0, 10) || 0);
            return e
        }
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getFirst: function(a) {
                var e = this.$.firstChild; (e = e && new CKEDITOR.dom.node(e)) && (a && !a(e)) && (e = e.getNext(a));
                return e
            },
            getLast: function(a) {
                var e = this.$.lastChild; (e = e && new CKEDITOR.dom.node(e)) && (a && !a(e)) && (e = e.getPrevious(a));
                return e
            },
            getStyle: function(a) {
            ...
            moveChildren: function(a, e) {
                ...
                if (b != a) {
                    var c;
                    if (e) for (; c = b.lastChild;) a.insertBefore(b.removeChild(c), a.firstChild);
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], h = 0; h < c.length; h++) if (f) for (var i = 0; i < f.length; i++) b.push([a, c[h], f[i]].join("-"));
            ...
            getDocumentPosition: function(a) {
                ...
                f = this.getDocument(),
                h = f.getBody(),
                i = f.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var m = this.$.getBoundingClientRect(),
                    p = f.$.documentElement,
                    s = p.clientTop || h.$.clientTop || 0,
                    x = p.clientLeft || h.$.clientLeft || 0,
                    q = true;
                    if (CKEDITOR.env.ie) {
            ...
            copyAttributes: function(a, b) {
                ...
                f = 0; f < c.length; f++) {
                    ...
                    m;
                    if (! (i in b)) if (i == "checked" && (m = this.getAttribute(i))) a.setAttribute(i, m);
            ...
            find: function(b) {
                var e = a(this),
                b = new CKEDITOR.dom.nodeList(this.$.querySelectorAll(c(this, b)));
                e();
                return b
            },
            findOne: function(b) {
                var e = a(this),
                b = this.$.querySelector(c(this, b));
                e();
    ...
    !0, {
        ...
        function a(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                ...
                r = d.type == CKEDITOR.NODE_ELEMENT ? d.getChild(m) : d.getNext();
            ...
            if (a && !this._.guardRTL) {
                ...
                i = e.type == CKEDITOR.NODE_ELEMENT ? f ? e.getChild(f - 1) : null: e.getPrevious();
            ...
            if (this.current) d = this.current[v](false, j, k);
            else {
                if (a) d.type == CKEDITOR.NODE_ELEMENT && (d = m > 0 ? d.getChild(m - 1) : k(d, true) === false ? null: d.getPreviousSourceNode(true, j, k));
                else {
                    d = e;
    ...
    CKEDITOR.dom.range = function(a) {
        ...
        function b(a) {
            return function() {
                var b;
                return this[a ? "getPreviousNode": "getNextNode"](function(a) { ! b && i(a) && (b = a);
        ...
        d = function(a, b, d, c) {
            ...
            if (e.type == CKEDITOR.NODE_TEXT) {
                ...
                k = true
            } else e = e.getChild(u).getPrevious();
            else {
            ...
            for (d = j; d < g.length; d++) {
                ...
                if (!u[d] || i.$.parentNode != u[d].$.parentNode) for (i = i.getPrevious(); i;) {
                    ...
                    F = i.getPrevious();
                    if (b == 2) r.$.insertBefore(i.$.cloneNode(true), r.$.firstChild);
                    else {
                        i.remove();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            getBoundaryNodes: function() {
                ...
                if (b.type == CKEDITOR.NODE_ELEMENT) {
                    e = b.getChildCount();
                    if (e > c) b = b.getChild(c).getPreviousSourceNode(true);
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (; j;) {
                            ...
                            if (j.type == CKEDITOR.NODE_COMMENT) j = j.getPrevious();
                                ...
                                if (j.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    h = j.getText();
                                    if (c.test(h)) j = null;
                                    else for (var n = j.$.getElementsByTagName("*"), F = 0, D; D = n[F++];) if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) {
                                        j = null;
                                        break
                                    }
                                    j && (r = !!h.length)
                    ...
                    if (r.type == CKEDITOR.NODE_TEXT) if (CKEDITOR.tools.trim(r.substring(n)).length) g = true;
                    else {
                        g = !r.getLength();
                        if (n == r.getLength()) {
            ...
            shrink: function(a, b, d) {
                if (!this.collapsed) {
                    ...
                    k = 1,
                    l = 1;
                    if (e && e.type == CKEDITOR.NODE_TEXT) if (u) if (u >= e.getLength()) c.setStartAfter(e);
                    else {
                        c.setStartBefore(e);
                        k = 0
                    } else c.setStartBefore(e);
                    if (f && f.type == CKEDITOR.NODE_TEXT) if (g) if (g >= f.getLength()) c.setEndAfter(f);
                    else {
                        c.setEndAfter(f);
                        l = 0
                    ...
                    c.guard = function(b, c) {
                        if (j(b)) return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || c && b.equals(v) || d === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return false; ! c && b.type == CKEDITOR.NODE_ELEMENT && (v = b);
                        return true
                    };
                    ...
                    if (l) {
                        c.reset(); (c = c[a == CKEDITOR.SHRINK_ELEMENT ? "lastBackward": "previous"]()) && this.setEndAt(c, b ? CKEDITOR.POSITION_BEFORE_END: CKEDITOR.POSITION_AFTER_END)
                    }
                    return ! (!k && !l)
                }
            },
            ...
            moveToElementEditablePosition: function(a, b) {
                ...
                for (var d = 0; a;) {
                    ...
                    e = d,
                    f = void 0;
                    c.type == CKEDITOR.NODE_ELEMENT && c.isEditable(false) && (f = c[b ? "getLast": "getFirst"](i)); ! e && !f && (f = c[b ? "getPrevious": "getNext"](i));
                    a = f
                }
                return !! d
            },
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; o;) {
                    var u = 0,
                    A = o.hasAscendant("pre"),
                    k = o.type != CKEDITOR.NODE_ELEMENT,
                    l = 0;
                    if (k) o.type == CKEDITOR.NODE_TEXT && d.test(o.getText()) && (k = 0);
                    else {
                        var j = o.getName();
                        if (CKEDITOR.dtd.$block[j] && o.getAttribute("contenteditable") == "false") {
                            ...
                            if (j == "br") k = 1;
                            else if (!g && !o.getChildCount() && j != "hr") {
                                b = o;
                                p = o.equals(q);
                                break
                            }
                ...
                if (!b) {
                    ...
                    b = b.block;
                    if (!b && o && !this.enforceRealBlocks && u[o.getName()] && g.checkStartOfBlock() && g.checkEndOfBlock() && !o.equals(g.root)) b = o;
    ...
    CKEDITOR.config = {
        ...
        function a(a, b, d, c, e) {
            ...
            c = a.length; d < c; ++d) {
                ...
                if (f.elements === true || f.elements === null) e[o ? "unshift": "push"](f);
                else {
                    j = f.elements;
                    delete f.elements;
                    for (i in j) if (b[i]) b[i][o ? "unshift": "push"](f);
                    else b[i] = [f]
                }
            }
        }
        ...
        function s(a) {
            ...
            d = a.classBackup = a.attributes["class"];
        ...
        function j(a, b, d) {
            var c = a.name;
            if (F.$empty[c] || !a.children.length) if (c == "hr" && b == "br") a.replaceWith(k());
            else {
                a.parent && d.push({
                    check: "it",
                    el: a.parent
                ...
                if (e) {
                    ...
                    e = a.parent;
                    for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.name == "body",
                    g, o = c.length; o > 0;) {
                        j = c[--o];
        ...
        function r(a, b) {
            ...
            else if (a instanceof CKEDITOR.style) c = a;
            else {
                d = a[0];
                c = a[1]
            }
        ...
        return {
            load: function(b, f, d, e) {
                ...
                if (n === 0) m(true);
                    ...
                    var p = function(a, b) { (b ? h: i).push(a);
                        if (--n <= 0) {
    ...
    CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
        ...
        function d(a, b, d) {
            if (b) {
                ...
                for (e in f) {
                    c = f[e]; (d || c.contextSensitive) && c.refresh(a, b)
                }
            }
        }
        function e(a) {
            ...
            d = x[b] || (x[b] = {});
            if (d.fn) {
                d.fn.call(a, a.config); (CKEDITOR.getUrl(a.config.customConfig) == b || !e(a)) && a.fireOnce("customConfigLoaded")
        ...
        function m(a) {
            ...
            c = b.extraPlugins,
            e = b.removePlugins;
            if (c) var f = RegExp("(?:^|,)(?:" + c.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
            d = d.replace(f, ""),
            d = d + ("," + c);
            if (e) var j = RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
            d = d.replace(j, "");
            ...
            function(d) {
                ...
                for (var k in d) {
                    ...
                    if (g && !a.lang[k]) {
                        g.split && (g = g.split(","));
                        if (CKEDITOR.tools.indexOf(g, a.langCode) >= 0) h = a.langCode;
                        else {
                            h = a.langCode.replace(/-.*/, "");
                            h = h != a.langCode && CKEDITOR.tools.indexOf(g, h) >= 0 ? h: CKEDITOR.tools.indexOf(g, "en") >= 0 ? "en": g[0]
                        }
                        if (!l.langEntries || !l.langEntries[h]) f.push(CKEDITOR.getUrl(l.path + "lang/" + h + ".js"));
                        else {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            _attachToForm: function() {
                var a = this,
                b = a.element,
                d = new CKEDITOR.dom.element(b.$.form);
                if (b.is("textarea") && d) {
                    var c = function(d) {
                        a.updateElement();
            ...
            setData: function(a, b, d) {
                ...
                if (e || !d) this.once("dataReady",
                function(a) { ! d && c && this.fire("saveSnapshot");
                    e && e.call(a.editor)
                });
                a = {
                    dataValue: a
                }; ! d && this.fire("setData", a);
                this._.data = a.dataValue; ! d && this.fire("afterSetData", a)
            },
            ...
            setKeystroke: function() {
                ...
                b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], d, c, e = b.length; e--;) {
                    d = b[e];
                    c = 0;
    ...
    CKEDITOR.htmlParser = function() {
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var f, d, e = 0,
                g; f = this._.htmlPartsRegex.exec(b);) {
                    d = f.index;
                    if (d > e) {
                        e = b.substring(e, d);
                        if (g) g.push(e);
                    ...
                    if (g) g.push(f[0]);
                        ...
                        if (!/="/.test(d)) {
                            ...
                            this.onTagOpen(d, n, i); ! g && CKEDITOR.dtd.$cdata[d] && (g = [])
                        }
    ...
    "use strict"; (function() {
        ...
        CKEDITOR.htmlParser.node.prototype = {
            ...
            getAscendant: function(a) {
                var c = typeof a == "function" ? a: typeof a == "string" ?
                function(b) {
                    return b.name == a
                }: function(b) {
                    return b.name in a
    ...
    CKEDITOR.htmlParser.fragment = function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(e, g, n) {
            ...
            function p(b, d, c) {
                ...
                if (b.previous === void 0) {
                    ...
                    m(b); (!a(b) || b.children.length) && d.add(b);
                    b.name == "pre" && (j = false);
            ...
            o = g instanceof CKEDITOR.htmlParser.element ? g: typeof g == "string" ? new CKEDITOR.htmlParser.element(g) : new CKEDITOR.htmlParser.fragment,
            u = [],
            A = [],
            k = o,
            l = o.name == "textarea",
                ...
                if (a(e)) u.push(e);
                    ...
                    if (d == "br") A.push(e);
                        ...
                        for (;;) {
                            ...
                            if (!e.isUnknown && !k.isUnknown && !o[d]) if (k.isOptionalClose) q.onTagClose(g);
                            else if (d in b && g in b) {
                                g = k.children; (g = g[g.length - 1]) && g.name == "li" || p(g = new CKEDITOR.htmlParser.element("li"), k); ! e.returnPoint && (e.returnPoint = k);
                                k = g
                            } else if (d in CKEDITOR.dtd.$listItem && !x(d, g)) q.onTagOpen(d == "li" ? "ul": "dl", {},
                            0, 1);
                            else if (g in c && !x(d, g)) { ! e.returnPoint && (e.returnPoint = k);
                                k = k.parent
                            } else {
                                g in CKEDITOR.dtd.$inline && u.unshift(k);
                                if (k.parent) p(k, k.parent, 1);
                                else {
                                    e.isOrphan = 1;
                                    break
                                }
            ...
            q.onText = function(a) {
                ...
                var b = k.name,
                e = b ? CKEDITOR.dtd[b] || (k._.isBlockLike ? CKEDITOR.dtd.div: CKEDITOR.dtd.span) : f;
                if (!l && !e["#"] && b in c) {
                    q.onTagOpen(d[b] || "");
                    q.onText(a)
                } else {
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            forEach: function(a, b, d) {
                ...
                if (c !== false) for (var d = this.children,
                f = 0; f < d.length; f++) {
                    c = d[f];
    ...
    "use strict"; (function() {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                addRules: function(a, f) {
                    var d;
                    if (typeof f == "number") d = f;
                    else if (f && "priority" in f) d = f.priority;
        ...
        a.prototype = {
            ...
            findIndex: function(a) {
                ...
                d = c.length - 1; d >= 0 && a < c[d].priority;) d--;
                return d + 1
            },
            exec: function(a, c) {
            ...
            execOnName: function(a, c) {
                ...
                g = e.length,
                n; c && d < g; d++) {
                    n = e[d]; ! (a.nonEditable && !n.options.applyToAll || a.nestedEditable && n.options.excludeNestedEditable) && (c = c.replace(n.value[0], n.value[1]))
                }
                return c
            }
        }
        ...
        function a(a, c) {
                ...
                return function(c) {
                    if (c.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (k) for (r(k, 1) && j.push(k); k;) {
                            if (e(k) && (o = f(k)) && r(o)) if ((g = f(o)) && !e(g)) j.push(o);
                            else {
                                l(v).insertAfter(o);
                                o.remove()
                            }
                        ...
                        if (j = typeof d == "function" ? d(c) !== false: d) if (!v && !CKEDITOR.env.needsBrFiller && c.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) j = false;
                        else if (!v && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || c.name in CKEDITOR.dtd.tr || c.name in CKEDITOR.dtd.$listItem)) j = false;
                        else {
                            j = b(c);
            ...
            function r(a, b) {
                ...
                if (a.type == CKEDITOR.NODE_TEXT && (d = a.value.match(u))) {
                    if (d.index) { (new CKEDITOR.htmlParser.text(a.value.substring(0, d.index))).insertBefore(a);
                        a.value = d[0]
                    }
                ...
                return function(b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in c || "data-cke-eol" in c) delete c["data-cke-bogus"];
                            ...
                            var j = f(b); ! c && e(b.parent) ? g(b.parent, l(a)) : e(c) && (j && !e(j)) && l(a).insertBefore(c)
                        }
                    }
                }
            } (v);
        ...
        function o(a, b) {
            for (var d = [], c = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = {
                id: 1
            }), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, c = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(c), a = a.replace(/<\!--[\s\S]*?--\>/g,
            function(a) {
                return "<\!--{cke_tempcomment}" + (d.push(a) - 1) + "--\>"
            }), j = 0; j < c.length; j++) a = a.replace(c[j],
            function(a) {
                a = a.replace(f,
                function(a, b, c) {
                    return d[c]
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            function(a) {
                ...
                d = i(d),
                d = m(d, L),
                d = d.replace(z, "$1cke:$2"),
                d = d.replace(E, "<cke:$1$2></cke:$1>"),
                d = d.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
                d = d.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + CKEDITOR.rnd + "-$2"),
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function(a, b, d, c) {
                ...
                if (b && typeof b == "object") {
                    ...
                    j = b.filter;
                    k = b.enterMode
                } else f = b; ! f && f !== null && (f = e.editable().getName());
        ...
        A = "{cke_protected}",
        k = CKEDITOR.dtd,
        l = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"],
        j = CKEDITOR.tools.extend({},
        k.$blockLimit, k.$block),
        v = {
            elements: {
                input: n,
                textarea: n
        ...
        var S = /<(a|area|img|input|source)\b([^>]*)>/gi,
        F = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
        D = /^(href|src|name)$/i,
    ...
    CKEDITOR.htmlParser.cssStyle = function(a) {
        var c = {}; ((a instanceof CKEDITOR.htmlParser.element ? a.attributes.style: a) || "").replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g,
        function(a, f, d) {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            getFirst: function(b) {
                ...
                for (var d = 0,
                c = this.children.length; d < c; ++d) if (b(this.children[d])) return this.children[d];
                return null
            },
            getHtml: function() {
    ...
    CKEDITOR.config.startupMode = "wysiwyg"; (function() {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var g, h;
                    if (f) for (; (g = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[g.getName()]) && (!h || !h[e]);) if (g.getName() in CKEDITOR.dtd.span) b.splitElement(g);
                ...
                insertElementIntoSelection: function(a) {
                    ...
                    if (this.insertElementIntoRange(a, d)) {
                        ...
                        if (e) if ((e = a.getNext(function(a) {
                            return f(a) && !i(a)
                        })) && e.type == CKEDITOR.NODE_ELEMENT && e.is(CKEDITOR.dtd.$block)) e.getDtd()["#"] ? d.moveToElementEditStart(e) : d.moveToElementEditEnd(a);
                ...
                setup: function() {
                    ...
                    function() {
                        var b = this.getData();
                        this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(m,
                        function(a, b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                                    ...
                                    a: {
                                        ...
                                        if (f) if (d[c ? "checkStartOfBlock": "checkEndOfBlock"]()) if (!d.moveToClosestEditablePosition(f, !c) || !d.collapsed) e = false;
                                            ...
                                            if ((d = d.startPath().block) && (!d || !d.contains(f))) {
                                                a.fire("saveSnapshot");
                                                var g; (g = (c ? d: f).getBogus()) && g.remove();
                                                e = a.getSelection();
                                                g = e.createBookmarks(); (c ? f: d).moveChildren(c ? d: f, false);
        ...
        p = CKEDITOR.dom.walker.whitespaces(true),
        ...
        var x = function() {
            ...
            function b(c, d) {
                ...
                for (var r = g[r.getName()], h = 0, i = c.getChildren(), m = i.count(), n = -1, q = -1, p = 0, s = e.contains(g.$list); h < m; ++h) {
                    ...
                    if (a(e)) {
                        j = e.getName();
                        if (s && j in CKEDITOR.dtd.$list) l = l.concat(b(e, d));
                        else {
                            k = !!r[j];
            ...
            return function(h, m, q) {
                ...
                if (!s.checkReadOnly()) {
                    var z = (new CKEDITOR.dom.elementPath(s.startContainer, s.root)).blockLimit || s.root,
                    m = {
                        type: m,
                        dontFilter: w,
                        editable: h,
                    ...
                    if (!p.collapsed) {
                        var z = y.block || y.blockLimit,
                        I = p.getCommonAncestor();
                    ...
                    t = p.createBookmark(); (z = t.startNode.getPrevious(f)) && a(z) && d(z) && w.push(z); (z = t.startNode.getNext(f)) && a(z) && d(z) && w.push(z);
                    ...
                    if (t = q) {
                        ...
                        if (/^\s+|\s+$/.test(q) && "span" in CKEDITOR.dtd[C]) var x = '<span data-cke-marker="1">&nbsp;</span>',
                        q = x + q + x;
                    ...
                    if (t) {
                        ...
                        for (j(E, G); t < E.length; t++) {
                            ...
                            if (B = y.isLineBreak) {
                                ...
                                if (y.hasBlockSibling) B = 1;
                                    ...
                                    if (!N || !N.is({
                                        ...
                                        W = N.getPosition(M);
                                        if (W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS) B = 0;
                                        else {
                                            M = B.splitElement(N);
                            ...
                            if (B) w = t > 0;
                                ...
                                if (y.lastNotAllowed && t < E.length - 1) { (T = I ? z: T) && G.setEndAt(T, CKEDITOR.POSITION_AFTER_START);
                                    p = 0
                                }
                                G.collapse()
                            }
                    ...
                    if (!m.dontMoveCaret) {
                        for (H = a(K.startContainer) && K.startContainer.getChild(K.startOffset - 1); H && a(H) && !H.is(g.$empty);) {
                            if (H.isBlockBoundary()) K.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END);
                            else {
        ...
        function f(a) {
            ...
            d = a.getPreviousNode(x, null, c),
            e = a.getNextNode(x, null, c);
        ...
        var p, s, x = CKEDITOR.dom.walker.invisible(1),
        q = function() {
            function a(b) {
                return function(a) {
        ...
        function(b) {
            ...
            function() {
                ...
                CKEDITOR.env.webkit && g.attachListener(b, "keydown",
                function(a) {
        ...
        CKEDITOR.editor.prototype.selectionChange = function(b) { (b ? a: c).call(this)
        };
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && n(a, b);
                ...
                if (o) b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && n(a, null, true);
            ...
            d = this.getNative();
            var f, g;
            if (d) if (d.getRangeAt) f = (g = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(g.commonAncestorContainer);
            else {
                try {
                    g = d.createRange()
                } catch(h) {}
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                ...
                function() {
                    ...
                    var b = function(b, c) {
                        ...
                        f, g, k = b.duplicate(), j = 0, h = e.length - 1, w = -1, i, t; j <= h;) {
                            w = Math.floor((j + h) / 2);
                            f = e[w];
            ...
            selectRanges: function(a) {
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    this.unlock();
                    this.selectRanges(a);
                    this.lock(); ! g.equals(this.root) && g.focus()
                } else {
                    var h;
                    a: {
                        var i, m;
    ...
    CKEDITOR.STYLE_OBJECT = 3; (function() {
            ...
            if (b.collapsed) {
                ...
                for (p.getPosition(n) == CKEDITOR.POSITION_FOLLOWING && (p = 0); p;) {
                    ...
                    if (p.equals(n)) {
                        ...
                        var s = p.type == CKEDITOR.NODE_ELEMENT ? p.getName() : null,
                        o = s && p.getAttribute("contentEditable") == "false",
                        r = s && p.getAttribute("data-nostyle");
                        if (s && p.data("cke-bookmark")) {
                            p = p.getNextSourceNode(true);
                            continue
                        }
                        if (o && j && CKEDITOR.dtd.$block[s]) for (var v = p,
                        A = f(v), D = void 0, I = A.length, O = 0, v = I && new CKEDITOR.dom.range(v.getDocument()); O < I; ++O) {
                            var D = A[O],
                            S = CKEDITOR.filter.instances[D.data("cke-filter")];
                            if (S ? S.check(this) : 1) {
                        ...
                        if (A) if ((A = p.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[e] || h) && (!g.parentRule || g.parentRule(A))) {
                            ...
                            if (s == CKEDITOR.NODE_TEXT || o || s == CKEDITOR.NODE_ELEMENT && !p.getChildCount()) {
                                for (var s = p,
                                P; (i = !s.getNext(F)) && (P = s.getParent(), k[P.getName()]) && (P.getPosition(l) | J) == J && (!g.childRule || g.childRule(P));) s = P;
                                q.setEndAfter(s)
                            }
                        } else i = true;
                        else i = true;
                    ...
                    if (i && q && !q.collapsed) {
                        for (var i = u(this, d), o = i.hasAttributes(), r = q.getCommonAncestor(), s = {},
                        A = {},
                        D = {},
                        I = {},
                        V, R, Y; i && r;) {
        ...
        function d(a) {
            var b = a.getEnclosedNode() || a.getCommonAncestor(false, true); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && A(a, this)
        }
        function e(a) {
        ...
        function k(a, b) {
            for (var c in a) a[c] = a[c].replace(S,
            function(a, c) {
                return b[c]
            })
        }
            ...
            if (!b) {
                ...
                function(a) {
                    for (var c = 0; c < b.length; c++) {
                        var e = b[c],
                        g = e.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON: CKEDITOR.TRISTATE_OFF;
                        e.fn.call(this, g)
                    }
                })
            }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        split: function(a) {
            ...
            f = this.getLength(),
            d = this.getDocument(),
            e = new CKEDITOR.dom.text(this.$.splitText(a), d);
                    ...
                    getNextRange: function(g) {
                        ...
                        if (n && a.length > 1) {
                            ...
                            if (g) for (var i = 0; a[e + i + 1];) {
                                for (var m = n.document,
                                g = 0,
                                h = m.getById(d[i].endNode), m = m.getById(d[i + 1].startNode);;) {
        ...
        if (CKEDITOR.env.webkit) CKEDITOR.env.hc = false;
            ...
            try {
                var c = a.getComputedStyle("border-top-color"),
    ...
    CKEDITOR.config.toolbarLocation = "top"; (function() {
        ...
        function l(c, e, b) {
            ...
            "wysiwyg" == c.mode && (e || (e = c.activeEnterMode), c.elementPath().isContextFor("p") || (e = CKEDITOR.ENTER_BR, b = 1), c.fire("saveSnapshot"), e == CKEDITOR.ENTER_BR ? o(c, e, null, b) : p(c, e, null, b), c.fire("saveSnapshot"))
        }
        function q(c) {
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function(c, e, b, h) {
                if (b = b || q(c)) {
                    ...
                    i = b.checkEndOfBlock(),
                    a = c.elementPath(b.startContainer).block,
                    k = e == CKEDITOR.ENTER_DIV ? "div": "p",
                    d;
                    if (j && i) {
                        if (a && (a.is("li") || a.getParent().is("li"))) {
                            ...
                            c = c.enterMode != CKEDITOR.ENTER_BR || l || n || i;
                            if (d.is("li")) if (h || m) a[h ? "insertBefore": "insertAfter"](d);
                            else a.breakParent(d);
                            else {
                                if (c) if (d = f.createElement(e == CKEDITOR.ENTER_P ? "p": "div"), l && d.setAttribute("dir", j), n && d.setAttribute("style", n), i && d.setAttribute("class", i), a.moveChildren(d), h || m) d[h ? "insertBefore": "insertAfter"](b);
                                else a.breakParent(b),
                                d.insertAfter(b);
                                else if (a.appendBogus(!0), h || m) for (; f = a[h ? "getFirst": "getLast"]();) f[h ? "insertBefore": "insertAfter"](b);
                    ...
                    if (i = b.splitBlock(k)) {
                        ...
                        else if (e && (g = e.getParent()) && g.is("li")) e.breakParent(g),
                        g = e.getNext(),
                        b.moveToElementEditStart(g),
                        e.move(e.getPrevious());
                        if (!c && !j) a.is("li") && (d = b.clone(), d.selectNodeContents(a), d = new CKEDITOR.dom.walker(d), d.evaluator = function(a) {
                        ...
                        a && b.moveToElementEditStart(a);
                            ...
                            d ? h && !d.is("li") && d.renameNode(k) : g && g.is("li") ? d = g: (d = f.createElement(k), e && (m = e.getDirection()) && d.setAttribute("dir", m));
                            if (f = i.elementPath) {
                                h = 0;
            ...
            enterBr: function(c, e, b, h) {
                if (b = b || q(c)) {
                    var f = b.document,
                    j = b.checkEndOfBlock(),
                    i = new CKEDITOR.dom.elementPath(c.getSelection().getStartElement()),
                    a = i.block,
                    k = a && i.block.getName(); ! h && "li" == k ? p(c, e, b, h) : (!h && j && r.test(k) ? (j = a.getDirection()) ? (f = f.createElement("div"), f.setAttribute("dir", j), f.insertAfter(a), b.setStart(f, 0)) : (f.createElement("br").insertAfter(a), CKEDITOR.env.gecko && f.createText("").insertAfter(a), b.setStartAt(a.getNext(), CKEDITOR.env.ie ? CKEDITOR.POSITION_BEFORE_START: CKEDITOR.POSITION_AFTER_START)) : (c = "pre" == k && CKEDITOR.env.ie && 8 > CKEDITOR.env.version ? f.createText("\r") : f.createElement("br"), b.deleteContents(), b.insertNode(c), CKEDITOR.env.needsBrFiller ? (f.createText("﻿").insertAfter(c), j && (a || i.blockLimit).appendBogus(), c.getNext().$.nodeValue = "", b.setStartAt(c.getNext(), CKEDITOR.POSITION_AFTER_START)) : b.setStartAt(c, CKEDITOR.POSITION_AFTER_END)), b.collapse(!0), b.select(), b.scrollIntoView())
                }
            }
        };
    ...
    CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
        ...
        function k(a) {
            ...
            e && e.parentNode.removeChild(e); (e = b.getElementById("cke_shimscrpt")) && e.parentNode.removeChild(e); (e = b.getElementById("cke_basetagscrpt")) && e.parentNode.removeChild(e);
            ...
            this.setup();
            CKEDITOR.env.ie && (b.getDocumentElement().addClass(b.$.compatMode), d.config.enterMode != CKEDITOR.ENTER_P && this.attachListener(b, "selectionchange",
            function() {
                var a = b.getBody(),
                c = d.getSelection(),
                e = c && c.getRanges()[0];
        ...
        var j = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                detach: function() {
                    ...
                    a.clearCustomData();
                    CKEDITOR.tools.removeFunction(this._.frameLoadedHandler); (d = a.removeCustomData("onResize")) && d.removeListener();
                    a.remove()
                }
            }
        })
    ...
    CKEDITOR.config.image_removeLinkByEmptyURL = !0; (function() {
        ...
        function P(a, c, d, b) {
            ...
            } (), f = c.getDocumentPosition(), i = {},
            h = {},
            g = {},
            j = {},
            l = t.length; l--;) i[t[l]] = parseInt(e("border-" + t[l] + "-width"), 10) || 0,
            g[t[l]] = parseInt(e("padding-" + t[l]), 10) || 0,
            h[t[l]] = parseInt(e("margin-" + t[l]), 10) || 0; (!d || b) && I(a, b);
            ...
            init: function(a) {
                ...
                function() {
                    ...
                    function() {
                        ...
                        50)))
                    }), d.attachListener(ea ? g: j, "mousedown",
                    function() {
                        "wysiwyg" == a.mode && (b.line.detach(), b.hiddenMode = 1, b.mouseDown = 1)
                    }), d.attachListener(ea ? g: j, "mouseup",
                    function() {
                        b.hiddenMode = 0;
                        b.mouseDown = 0
        ...
        da = function() {
            function a(a) {
                ...
                h, g, j, l; f && !f.equals(e) && (g = e.getNext(a.isRelevant));) h = Math.abs(ga(a, e, g) - a.mouse.y),
                h < b && (b = h, j = e, l = g),
                e = g,
                o(a, e);
        ...
        CKEDITOR.plugins.add("undo", {
            init: function(a) {
                ...
                function() {
                    ...
                    function(a) { - 1 < CKEDITOR.tools.indexOf(h, a.data.getKeystroke()) && a.data.preventDefault()
                    })
                });
                b.onChange = function() {
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,a11yhelp,basicstyles,blockquote,clipboard,panel,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc,print,preview,font,panelbutton,colorbutton';
    CKEDITOR.config.skin = 'bootstrapck'; (function() {
        ...
        if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,blockquote,168,,copy-rtl,192,,copy,216,,cut-rtl,240,,cut,264,,paste-rtl,288,,paste,312,,horizontalrule,336,,image,360,,indent-rtl,384,,indent,408,,outdent-rtl,432,,outdent,456,,anchor-rtl,480,,anchor,504,,link,528,,unlink,552,,bulletedlist-rtl,576,,bulletedlist,600,,numberedlist-rtl,624,,numberedlist,648,,maximize,672,,pastetext-rtl,696,,pastetext,720,,pastefromword-rtl,744,,pastefromword,768,,removeformat,792,,source-rtl,816,,source,840,,specialchar,864,,scayt,888,,table,912,,redo-rtl,936,,redo,960,,undo-rtl,984,,undo,1008,,spellchecker,1032,,print,1056,,preview-rtl,1080,,preview,1104,,bgcolor,1128,,textcolor,1152,', 'icons_hidpi.png');
        else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,blockquote,168,auto,copy-rtl,192,auto,copy,216,auto,cut-rtl,240,auto,cut,264,auto,paste-rtl,288,auto,paste,312,auto,horizontalrule,336,auto,image,360,auto,indent-rtl,384,auto,indent,408,auto,outdent-rtl,432,auto,outdent,456,auto,anchor-rtl,480,auto,anchor,504,auto,link,528,auto,unlink,552,auto,bulletedlist-rtl,576,auto,bulletedlist,600,auto,numberedlist-rtl,624,auto,numberedlist,648,auto,maximize,672,auto,pastetext-rtl,696,auto,pastetext,720,auto,pastefromword-rtl,744,auto,pastefromword,768,auto,removeformat,792,auto,source-rtl,816,auto,source,840,auto,specialchar,864,auto,scayt,888,auto,table,912,auto,redo-rtl,936,auto,redo,960,auto,undo-rtl,984,auto,undo,1008,auto,spellchecker,1032,auto,print,1056,auto,preview-rtl,1080,auto,preview,1104,auto,bgcolor,1128,auto,textcolor,1152,auto', 'icons.png');
    })();
